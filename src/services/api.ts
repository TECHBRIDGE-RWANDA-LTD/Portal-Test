...
export const apiService = {
  ...
  submitPermit: async (formData: ClearanceFormData): Promise<ClearanceRequest> => {
    const payload = {
      ...
      has_electronic_warfare: Boolean(formData.has_electronic_warfare),
      electronic_warfare_details: formData.electronic_warfare_details || '',
      has_aircraft_modifications: Boolean(formData.has_aircraft_modifications),
      aircraft_modifications_details: formData.aircraft_modifications_details || '',
      clearance_category: formData.clearance_category || 'Overflight',
      clearance_type: formData.clearance_type || 'Diplomatic',
      ...
      passengers_count: Number(formData.passengers_count) || 0,
